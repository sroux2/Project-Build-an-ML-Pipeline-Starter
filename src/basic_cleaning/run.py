...
def go(args):
    ...
    # ENTER CODE HERE
    git idx = df['longitude'].between(-74.25, -73.50) & df['latitude'].between(40.5, 41.2)
    df = df[idx].copy()
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input_artifact", 
        type=str,
        help="fully qualified input artifact path",
        required=True
    )
    ...
    parser.add_argument(
        "--output_artifact", 
        type=str,
        help="fully qualified output artifact path",
        required=True
    )
    ...
    parser.add_argument(
        "--output_description", 
        type=str,
        help="output file, clean_sample.csv",
        required=True
    )
    ...
    parser.add_argument(
        "--min_price", 
        type=float,
        help="minimum price acceptable for the analysis",
        required=True
    )
    ...
    parser.add_argument(
        "--max_price",
        type=float,
        help="maximum price acceptable for the analysis",
        required=True
    )
